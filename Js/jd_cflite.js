...
proxy-groups:
    - { name: Proxy, type: select, proxies: [自动选择, 故障转移, Auto_us, CFTR, 'CFNB-UK-V6', 'CFTN-HK-V6', 'CF63-HK-V6', 'CFT2-US-V6'] }
    ...
    - { name: EmbyVIP, type: select, proxies: [Proxy, DIRECT, Auto_us, CFTR] }
    - { name: EmbyDMM, type: select, proxies: [Proxy, Auto_us, CFTR] }
    - { name: ChatGPT, type: select, proxies: [Proxy, CFTR] }
    - { name: Telegram, type: select, proxies: [Proxy, Auto_us, CFTR] }
    - { name: Apple, type: select, proxies: [DIRECT, Proxy, Auto_us, CFTR] }
    - { name: Microsoft, type: select, proxies: [DIRECT, Proxy, Auto_us, CFTR] }
    - { name: Steam, type: select, proxies: [DIRECT, Proxy] }
    - { name: Netflix, type: select, proxies: [Proxy, '🇭🇰 CFTN-HK-V6', '🇭🇰 CF63-HK-V6'] }
    - { name: Spotify, type: select, proxies: [Proxy, Auto_us, CFTR] }
    - { name: YouTube, type: select, proxies: [Proxy, Auto_us, CFTR] }
    - { name: Disney, type: select, proxies: [Proxy] }
    - { name: 'Apple TV', type: select, proxies: [DIRECT, Proxy, Auto_us, CFTR] }
    - { name: 'Asian TV', type: select, proxies: [DIRECT, Proxy, Auto_us, CFTR] }
    - { name: 'Global TV', type: select, proxies: [Proxy, Auto_us, CFTR] }
    - { name: Crypto, type: select, proxies: [Proxy, Auto_us, CFTR] }
    - { name: Discord, type: select, proxies: [Proxy, Auto_us, CFTR] }
    - { name: Speedtest, type: select, proxies: [DIRECT, Proxy, Auto_us] }
    - { name: PayPal, type: select, proxies: [Proxy, DIRECT] }
    - { name: 'Google FCM', type: select, proxies: [DIRECT, Proxy, Auto_us, CFTR] }
    - { name: Scholar, type: select, proxies: [Proxy, Auto_us, CFTR] }
    - { name: AdBlock, type: select, proxies: [REJECT, DIRECT] }
    - { name: Domestic, type: select, proxies: [DIRECT, Proxy, Auto_us] }
rules:
