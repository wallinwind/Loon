...
proxy-groups:
    - { name: Proxy, type: select, proxies: [自动选择, 故障转移, 'CFIR-US', 'CFFG-US', 'CF12-US', 'CFNI-US', 'CFCD-US', 'CFZ6-US', 'CFF3-US', 'CFSA-US', 'CFEC-US'] }
    - { name: 自动选择, type: url-test, proxies: ['CFIR-US', 'CFFG-US', 'CF12-US', 'CFNI-US', 'CFCD-US', 'CFZ6-US', 'CFF3-US', 'CFSA-US', 'CFEC-US'], url: 'http://www.gstatic.com/generate_204', interval: 300 }
    - { name: 故障转移, type: fallback, proxies: ['CFIR-US', 'CFFG-US', 'CF12-US', 'CFNI-US', 'CFCD-US', 'CFZ6-US', 'CFF3-US', 'CFSA-US', 'CFEC-US'], url: 'http://www.gstatic.com/generate_204', interval: 300 }
    - { name: EmbyVIP, type: select, proxies: [Proxy, DIRECT] }
    - { name: EmbyDMM, type: select, proxies: [Proxy] }
    - { name: ChatGPT, type: select, proxies: [Proxy] }
    ...
    - { name: Spotify, type: select, proxies: [Proxy] }
    - { name: YouTube, type: select, proxies: [Proxy] }
    - { name: Disney, type: select, proxies: [Proxy] }
    - { name: 'Apple TV', type: select, proxies: [DIRECT, Proxy] }
    - { name: 'Asian TV', type: select, proxies: [DIRECT, Proxy] }
    - { name: 'Global TV', type: select, proxies: [Proxy] }
    - { name: Crypto, type: select, proxies: [Proxy] }
    - { name: Discord, type: select, proxies: [Proxy] }
    ...
    - { name: Scholar, type: select, proxies: [Proxy] }
