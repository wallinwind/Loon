...
proxy-groups:
    ...
    - { name: Telegram, type: select, proxies: [Proxy, Auto_us, Auto_sg] }
    - { name: Apple, type: select, proxies: [DIRECT, Proxy, Auto_us, Auto_sg] }
    - { name: Microsoft, type: select, proxies: [DIRECT, Proxy, Auto_us, Auto_sg] }
    - { name: Steam, type: select, proxies: [DIRECT, Proxy, Auto_us, Auto_sg] }
    - { name: Netflix, type: select, proxies: [Proxy, Auto_us, Auto_sg] }
    - { name: Spotify, type: select, proxies: [Proxy, Auto_us, Auto_sg] }
    - { name: YouTube, type: select, proxies: [Proxy, Auto_us, Auto_sg] }
    - { name: Disney, type: select, proxies: [Proxy, Auto_us, Auto_sg] }
    - { name: 'Apple TV', type: select, proxies: [DIRECT, Proxy, Auto_us, Auto_sg] }
    - { name: 'Asian TV', type: select, proxies: [DIRECT, Proxy, Auto_us, Auto_sg] }
    - { name: 'Global TV', type: select, proxies: [Proxy, Auto_us, Auto_sg] }
    - { name: Crypto, type: select, proxies: [Proxy, Auto_us, Auto_sg] }
    - { name: Discord, type: select, proxies: [Proxy, Auto_us, Auto_sg] }
    - { name: Speedtest, type: select, proxies: [DIRECT, Proxy, Auto_us, Auto_sg] }
    - { name: PayPal, type: select, proxies: [Proxy, DIRECT, Auto_us, Auto_sg] }
    - { name: 'Google FCM', type: select, proxies: [DIRECT, Proxy, Auto_us, Auto_sg] }
    - { name: Scholar, type: select, proxies: [Proxy, Auto_us, Auto_sg] }
    - { name: AdBlock, type: select, proxies: [REJECT, DIRECT] }
    - { name: Domestic, type: select, proxies: [DIRECT, Proxy, Auto_us, Auto_sg] }
rules:
