...
proxy-groups:
    - { name: Proxy, type: select, proxies: [CFTR, '🇺🇸 US-0-0', '🇺🇸 US-SAN JOSE-SJC 01', '🇰🇷 NRT 01', '🇰🇷 KR 07', '🇭🇰 CFTN-HK-V6', '🇭🇰 CF63-HK-V6'] }
    ...
    - { name: Telegram, type: select, proxies: [Proxy, CFTR] }
    ...
    - { name: 'Apple TV', type: select, proxies: [DIRECT, Proxy, CFTR] }
    - { name: 'Asian TV', type: select, proxies: [DIRECT, Proxy, CFTR] }
    - { name: 'Global TV', type: select, proxies: [Proxy, CFTR] }
    - { name: Crypto, type: select, proxies: [Proxy, CFTR] }
    - { name: Discord, type: select, proxies: [Proxy, CFTR] }
    - { name: Speedtest, type: select, proxies: [DIRECT, Proxy] }
    - { name: PayPal, type: select, proxies: [Proxy, DIRECT] }
    - { name: 'Google FCM', type: select, proxies: [DIRECT, Proxy, CFTR] }
    - { name: Scholar, type: select, proxies: [Proxy, CFTR] }
