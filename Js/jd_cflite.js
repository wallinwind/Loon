...
proxy-groups:
    - { name: Proxy, type: select, proxies: [自动选择, 故障转移, Auto_us, 'CFIR-US', 'CFFG-US', 'CF12-US', 'CFNI-US', 'CFCD-US', 'CFZ6-US', 'CFF3-NL', 'CFSA-KR', 'CFEC-US', 'CFNB-US', 'CFTN-US', 'CF63-HKv6'] }
    - { name: 自动选择, type: url-test, proxies: ['CFIR-US', 'CFFG-US', 'CF12-US', 'CFNI-US', 'CFCD-US', 'CFZ6-US', 'CFF3-NL', 'CFSA-KR', 'CFEC-US', 'CFNB-US', 'CFTN-US', 'CF63-HKv6'], url: 'http://www.gstatic.com/generate_204', interval: 300 }
    - { name: 故障转移, type: fallback, proxies: ['CFIR-US', 'CFFG-US', 'CF12-US', 'CFNI-US', 'CFCD-US', 'CFZ6-US', 'CFF3-NL', 'CFSA-KR', 'CFEC-US', 'CFNB-US', 'CFTN-US', 'CF63-HKv6'], url: 'http://www.gstatic.com/generate_204', interval: 300 }
    ...
    - { name: EmbyVIP, type: select, proxies: [Proxy, DIRECT, Auto_us] }
    - { name: EmbyDMM, type: select, proxies: [Proxy, Auto_us] }
    - { name: ChatGPT, type: select, proxies: [Proxy, Auto_us] }
    - { name: Telegram, type: select, proxies: [Proxy, Auto_us] }
    - { name: Apple, type: select, proxies: [DIRECT, Proxy, Auto_us] }
    - { name: Microsoft, type: select, proxies: [DIRECT, Proxy, Auto_us] }
    - { name: Steam, type: select, proxies: [DIRECT, Proxy, Auto_us] }
    - { name: Netflix, type: select, proxies: [Proxy, Auto_us] }
    - { name: Spotify, type: select, proxies: [Proxy, Auto_us] }
    - { name: YouTube, type: select, proxies: [Proxy, Auto_us] }
    - { name: Disney, type: select, proxies: [Proxy, Auto_us] }
    - { name: 'Apple TV', type: select, proxies: [DIRECT, Proxy, Auto_us] }
    - { name: 'Asian TV', type: select, proxies: [DIRECT, Proxy, Auto_us] }
    - { name: 'Global TV', type: select, proxies: [Proxy, Auto_us] }
    - { name: Crypto, type: select, proxies: [Proxy, Auto_us] }
    - { name: Discord, type: select, proxies: [Proxy, Auto_us] }
    - { name: Speedtest, type: select, proxies: [DIRECT, Proxy, Auto_us] }
    - { name: PayPal, type: select, proxies: [Proxy, DIRECT, Auto_us] }
    - { name: 'Google FCM', type: select, proxies: [DIRECT, Proxy, Auto_us] }
    - { name: Scholar, type: select, proxies: [Proxy, Auto_us] }
