...
proxies:
    - { name: 'CFT2-Test', type: vless, server: 47.57.233.126, port: 80, uuid: 66715dc1-eb36-42f0-8dc1-48db4087452e, udp: false, tls: false, network: ws, ws-opts: { path: '/?ed=2048', headers: { Host: worker-white-bush-a23f.t23pfjbk.workers.dev } } }
    ...
    - { name: 'CFCD-US', type: vless, server: 149.129.8.215, port: 80, uuid: 66715dc1-eb36-42f0-8dc1-48db4087452e, udp: false, tls: false, network: ws, ws-opts: { path: '/?ed=2048', headers: { Host: worker-ancient-queen-3a7b.cdb9vs0r.workers.dev } } }	
    ...
    - { name: 'CFNB-JP', type: vless, server: 146.56.182.21, port: 80, uuid: 66715dc1-eb36-42f0-8dc1-48db4087452e, udp: false, tls: false, network: ws, ws-opts: { path: '/?ed=2048', headers: { Host: worker-misty-smoke-d7f9.nb13l3ox.workers.dev } } }
...
proxy-groups:
    - { name: Proxy, type: select, proxies: [自动选择, 故障转移, Auto_us, 'CFT2-Test', 'CFIR-US', 'CFFG-US', 'CF12-US', 'CFNI-US', 'CFCD-US', 'CFZ6-US', 'CFF3-US', 'CFSA-US', 'CFEC-US', 'CFNB-JP', 'CFTN-HK', 'CF63-HK', '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: 自动选择, type: url-test, proxies: ['CFIR-US', 'CFFG-US', 'CF12-US', 'CFNI-US', 'CFCD-US', 'CFZ6-US', 'CFF3-US', 'CFSA-US', 'CFEC-US', 'CFNB-JP', 'CFTN-HK', 'CF63-HK'], url: 'http://www.gstatic.com/generate_204', interval: 300 }
    - { name: 故障转移, type: fallback, proxies: ['CFIR-US', 'CFFG-US', 'CF12-US', 'CFNI-US', 'CFCD-US', 'CFZ6-US', 'CFF3-US', 'CFSA-US', 'CFEC-US', 'CFNB-JP', 'CFTN-HK', 'CF63-HK'], url: 'http://www.gstatic.com/generate_204', interval: 300 }
