...
proxy-groups:
    - { name: Proxy, type: select, proxies: [自动选择, 故障转移, Auto_us, 'CFIR-US', 'CFFG-US', 'CF12-US', 'CFNI-US', 'CFCD-US', 'CFZ6-US', 'CFF3-US', 'CFSA-US', 'CFEC-US', 'CFNB-UK-V6', 'CFTN-HK-V6', 'CF63-HK-V6', 'CFT2-HK-V6', '香港 Cera Hysteria2'] }
    ...
    - { name: EmbyVIP, type: select, proxies: [Proxy, DIRECT, Auto_us, '香港 Cera Hysteria2'] }
    - { name: EmbyDMM, type: select, proxies: [Proxy, Auto_us, '香港 Cera Hysteria2'] }
    - { name: ChatGPT, type: select, proxies: [Proxy, Auto_us] }
    - { name: Telegram, type: select, proxies: [Proxy, Auto_us, '香港 Cera Hysteria2'] }
    - { name: Apple, type: select, proxies: [DIRECT, Proxy, Auto_us, '香港 Cera Hysteria2'] }
    - { name: Microsoft, type: select, proxies: [DIRECT, Proxy, Auto_us, '香港 Cera Hysteria2'] }
    - { name: Steam, type: select, proxies: [DIRECT, Proxy, Auto_us, '香港 Cera Hysteria2'] }
    - { name: Netflix, type: select, proxies: [Proxy, Auto_us, '香港 Cera Hysteria2'] }
    - { name: Spotify, type: select, proxies: [Proxy, Auto_us, '香港 Cera Hysteria2'] }
    - { name: YouTube, type: select, proxies: [Proxy, Auto_us, '香港 Cera Hysteria2'] }
    - { name: Disney, type: select, proxies: [Proxy, Auto_us, '香港 Cera Hysteria2'] }
    - { name: 'Apple TV', type: select, proxies: [DIRECT, Proxy, Auto_us, '香港 Cera Hysteria2'] }
    - { name: 'Asian TV', type: select, proxies: [DIRECT, Proxy, Auto_us, '香港 Cera Hysteria2'] }
    - { name: 'Global TV', type: select, proxies: [Proxy, Auto_us, '香港 Cera Hysteria2'] }
    - { name: Crypto, type: select, proxies: [Proxy, Auto_us, '香港 Cera Hysteria2'] }
    - { name: Discord, type: select, proxies: [Proxy, Auto_us, '香港 Cera Hysteria2'] }
    - { name: Speedtest, type: select, proxies: [DIRECT, Proxy, Auto_us, '香港 Cera Hysteria2'] }
    - { name: PayPal, type: select, proxies: [Proxy, DIRECT, Auto_us, '香港 Cera Hysteria2'] }
    - { name: 'Google FCM', type: select, proxies: [DIRECT, Proxy, Auto_us, '香港 Cera Hysteria2'] }
    - { name: Scholar, type: select, proxies: [Proxy, Auto_us, '香港 Cera Hysteria2'] }
    - { name: AdBlock, type: select, proxies: [REJECT, DIRECT] }
    - { name: Domestic, type: select, proxies: [DIRECT, Proxy, Auto_us, '香港 Cera Hysteria2'] }
rules:
