...
proxies:
    ...
    - { name: 'CFF3-US', type: vless, server: 162.159.160.208, port: 80, uuid: 66715dc1-eb36-42f0-8dc1-48db4087452e, udp: false, tls: false, network: ws, ws-opts: { path: '/?ed=2048', headers: { Host: worker-summer-resonance-9629.iamnoname.workers.dev } } }
    ...
    - { name: 'CFNB-US-V6', type: vless, server: 2606:4700:3038:1f1e:1e1a:9120:a2f1:bb8a, port: 80, uuid: 66715dc1-eb36-42f0-8dc1-48db4087452e, udp: false, tls: false, network: ws, ws-opts: { path: '/?ed=2048', headers: { Host: worker-misty-smoke-d7f9.nb13l3ox.workers.dev } } }
    ...
    - { name: 'CFT2-HK-V6', type: vless, server: 2606:4700:90d7:37c6:f925:5395:ded3:9548, port: 80, uuid: 66715dc1-eb36-42f0-8dc1-48db4087452e, udp: false, tls: false, network: ws, ws-opts: { path: '/?ed=2048', headers: { Host: worker-white-bush-a23f.t23pfjbk.workers.dev } } }
    ...
    - { name: '香港 Cera Reality-gRPC', type: vless, server: 156.251.182.115, port: 8007, uuid: 133b544b-a3ec-4f96-b3bd-f86b2e8396fa,  udp: true, tls: true, skip-cert-verify: false, flow: '', client-fingerprint: chrome, servername: updates.cdn-apple.com, reality-opts: { public-key: sSKfx0nCMQw1DqK3irHZyTVmIV6LsH0Hu-n6iF5zzBE, short-id: 062f7da5 }, network: grpc, grpc-opts: { grpc-service-name: grpc } }
    - { name: '香港 Cera Reality-Vision', type: vless, server: 156.251.182.115, port: 8006, uuid: 133b544b-a3ec-4f96-b3bd-f86b2e8396fa, udp: true, tls: true, skip-cert-verify: false, flow: xtls-rprx-vision, client-fingerprint: chrome, servername: updates.cdn-apple.com, reality-opts: { public-key: sSKfx0nCMQw1DqK3irHZyTVmIV6LsH0Hu-n6iF5zzBE, short-id: 062f7da5 } }
proxy-groups:
    - { name: Proxy, type: select, proxies: [自动选择, 故障转移, Auto_us, 'CFIR-US', 'CFFG-US', 'CF12-US', 'CFNI-US', 'CFCD-US', 'CFZ6-US', 'CFF3-US', 'CFSA-US', 'CFEC-US', 'CFNB-US-V6', 'CFTN-HK-V6', 'CF63-HK-V6', 'CFT2-HK-V6', '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: 自动选择, type: url-test, proxies: ['CFIR-US', 'CFFG-US', 'CF12-US', 'CFNI-US', 'CFCD-US', 'CFZ6-US', 'CFF3-US', 'CFSA-US', 'CFEC-US', 'CFNB-US-V6', 'CFTN-HK-V6', 'CF63-HK-V6', 'CFT2-HK-V6'], url: 'http://www.gstatic.com/generate_204', interval: 300 }
    - { name: 故障转移, type: fallback, proxies: ['CFIR-US', 'CFFG-US', 'CF12-US', 'CFNI-US', 'CFCD-US', 'CFZ6-US', 'CFF3-US', 'CFSA-US', 'CFEC-US', 'CFNB-US-V6', 'CFTN-HK-V6', 'CF63-HK-V6', 'CFT2-HK-V6'], url: 'http://www.gstatic.com/generate_204', interval: 300 }
    ...
    - { name: EmbyVIP, type: select, proxies: [Proxy, DIRECT, Auto_us, '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: EmbyDMM, type: select, proxies: [Proxy, Auto_us, '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: ChatGPT, type: select, proxies: [Proxy, Auto_us] }
    - { name: Telegram, type: select, proxies: [Proxy, Auto_us, '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: Apple, type: select, proxies: [DIRECT, Proxy, Auto_us, '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: Microsoft, type: select, proxies: [DIRECT, Proxy, Auto_us, '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: Steam, type: select, proxies: [DIRECT, Proxy, Auto_us, '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: Netflix, type: select, proxies: [Proxy, Auto_us, '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: Spotify, type: select, proxies: [Proxy, Auto_us, '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: YouTube, type: select, proxies: [Proxy, Auto_us, '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: Disney, type: select, proxies: [Proxy, Auto_us, '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: 'Apple TV', type: select, proxies: [DIRECT, Proxy, Auto_us, '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: 'Asian TV', type: select, proxies: [DIRECT, Proxy, Auto_us, '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: 'Global TV', type: select, proxies: [Proxy, Auto_us, '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: Crypto, type: select, proxies: [Proxy, Auto_us, '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: Discord, type: select, proxies: [Proxy, Auto_us, '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: Speedtest, type: select, proxies: [DIRECT, Proxy, Auto_us, '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: PayPal, type: select, proxies: [Proxy, DIRECT, Auto_us, '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: 'Google FCM', type: select, proxies: [DIRECT, Proxy, Auto_us, '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: Scholar, type: select, proxies: [Proxy, Auto_us, '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: AdBlock, type: select, proxies: [REJECT, DIRECT] }
    - { name: Domestic, type: select, proxies: [DIRECT, Proxy, Auto_us, '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
rules:
