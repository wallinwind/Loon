...
proxies:
    ...
    - {name: '🇭🇰 HONG KONG-HKS9-WORK 01', server: 119.247.140.108, port: 29722, type: vless, uuid: 89b3cbba-e6ac-485a-9481-976a0415eab9, tls: true, servername: cf.hughhad.us.kg, network: ws, ws-opts: {path: "/?ed=2560", headers: {Host: cf.hughhad.us.kg}}, udp: true}
proxy-groups:
    - { name: Proxy, type: select, proxies: [CFTR, '🇺🇸 US-SAN JOSE-SJC 01', '🇺🇸 US-156', '🇰🇷 NRT 01', '🇰🇷 KR 16', '🇭🇰 HONG KONG-HKS9-WORK 01', 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    ...
    - { name: EmbyVIP, type: select, proxies: [Proxy, DIRECT, CFTR, 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: EmbyDMM, type: select, proxies: [Proxy, CFTR, 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: ChatGPT, type: select, proxies: [CFTR, 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: Telegram, type: select, proxies: [Proxy, CFTR, 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: Apple, type: select, proxies: [DIRECT, Proxy, CFTR, 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: Microsoft, type: select, proxies: [DIRECT, Proxy, CFTR, 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: Steam, type: select, proxies: [DIRECT, Proxy, 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: Netflix, type: select, proxies: [Proxy, 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: Spotify, type: select, proxies: [Proxy, CFTR, 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: YouTube, type: select, proxies: [Proxy, CFTR, 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: Disney, type: select, proxies: [Proxy, CFTR, 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: 'Apple TV', type: select, proxies: [DIRECT, Proxy, CFTR, 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: 'Asian TV', type: select, proxies: [DIRECT, Proxy, CFTR, 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: 'Global TV', type: select, proxies: [Proxy, CFTR, 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: Crypto, type: select, proxies: [Proxy, CFTR, 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: Discord, type: select, proxies: [Proxy, CFTR, 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: Speedtest, type: select, proxies: [DIRECT, Proxy, CFTR, 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: PayPal, type: select, proxies: [Proxy, DIRECT, 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: 'Google FCM', type: select, proxies: [DIRECT, Proxy, CFTR, 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: Scholar, type: select, proxies: [Proxy, CFTR, 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: AdBlock, type: select, proxies: [REJECT, DIRECT] }
    - { name: Domestic, type: select, proxies: [DIRECT, Proxy, CFTR, 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
rules:
