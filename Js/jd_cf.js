...
proxies:
    - { name: 'CFT2-Test', type: vless, server: 8.222.207.208, port: 80, uuid: 66715dc1-eb36-42f0-8dc1-48db4087452e, udp: false, tls: false, network: ws, ws-opts: { path: '/?ed=2048', headers: { Host: worker-white-bush-a23f.t23pfjbk.workers.dev } } }
    ...
    - { name: 'CFEC-JP', type: vless, server: 146.56.188.71, port: 80, uuid: 66715dc1-eb36-42f0-8dc1-48db4087452e, udp: false, tls: false, network: ws, ws-opts: { path: '/?ed=2048', headers: { Host: worker-twilight-shadow-2a8c.ecwm1qv8.workers.dev } } }
    ...
    - { name: 'CF63-KR', type: vless, server: 129.154.61.243, port: 80, uuid: 66715dc1-eb36-42f0-8dc1-48db4087452e, udp: false, tls: false, network: ws, ws-opts: { path: '/?ed=2048', headers: { Host: worker-cold-moon-5edb.63cdk1pq.workers.dev } } }
...
proxy-groups:
    - { name: Proxy, type: select, proxies: [自动选择, 故障转移, Auto_us, 'CFT2-Test', 'CFIR-US', 'CFFG-US', 'CF12-US', 'CFNI-US', 'CFCD-US', 'CFZ6-US', 'CFF3-JP', 'CFSA-JP', 'CFEC-JP', 'CFNB-JP', 'CFTN-JP', 'CF63-KR', '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: 自动选择, type: url-test, proxies: ['CFIR-US', 'CFFG-US', 'CF12-US', 'CFNI-US', 'CFCD-US', 'CFZ6-US', 'CFF3-JP', 'CFSA-JP', 'CFEC-JP', 'CFNB-JP', 'CFTN-JP', 'CF63-KR'], url: 'http://www.gstatic.com/generate_204', interval: 300 }
    - { name: 故障转移, type: fallback, proxies: ['CFIR-US', 'CFFG-US', 'CF12-US', 'CFNI-US', 'CFCD-US', 'CFZ6-US', 'CFF3-JP', 'CFSA-JP', 'CFEC-JP', 'CFNB-JP', 'CFTN-JP', 'CF63-KR'], url: 'http://www.gstatic.com/generate_204', interval: 300 }
