...
proxies:
    - { name: 'CFIR-US', type: vless, server: v4.cfnode.eu.org, port: 80, uuid: 66715dc1-eb36-42f0-8dc1-48db4087452e, udp: false, tls: false, network: ws, ws-opts: { path: '/?ed=2048', headers: { Host: worker-misty-rain-6834.pushwall.workers.dev } } }
    ...
    - { name: 'CFF3-US', type: vless, server: 172.64.91.85, port: 80, uuid: 66715dc1-eb36-42f0-8dc1-48db4087452e, udp: false, tls: false, network: ws, ws-opts: { path: '/?ed=2048', headers: { Host: worker-summer-resonance-9629.iamnoname.workers.dev } } }
    ...
    - { name: '☁️ CFWarp-F', type: wireguard, ip: 172.16.0.2,  ipv6: fd01:5ca1:ab1e:80fa:ab85:6eea:213f:f4a5, private-key: SHVqHEGI7k2+OQ/oWMmWY2EQObbRQjRBdDPimh0h1WY=, server: 162.159.195.92, port: 1070, public-key: bmXOC+F1FxEMF9dyiK2H5/1SUtzH0JuVo51h2wPfgyo=, allowed-ips: ["0.0.0.0/0,::0/0"], udp: true, mtu: 1300, remote-dns-resolve: true, dns: [1.1.1.1, 1.0.0.1]}
    - { name: '☁️ CFWarp-G', type: wireguard, ip: 172.16.0.2,  ipv6: fd01:5ca1:ab1e:80fa:ab85:6eea:213f:f4a5, private-key: SHVqHEGI7k2+OQ/oWMmWY2EQObbRQjRBdDPimh0h1WY=, server: 162.159.195.11, port: 7559, public-key: bmXOC+F1FxEMF9dyiK2H5/1SUtzH0JuVo51h2wPfgyo=, allowed-ips: ["0.0.0.0/0,::0/0"], udp: true, mtu: 1300, remote-dns-resolve: true, dns: [1.1.1.1, 1.0.0.1]}
    - { name: '☁️ CFWarp-H', type: wireguard, ip: 172.16.0.2,  ipv6: fd01:5ca1:ab1e:80fa:ab85:6eea:213f:f4a5, private-key: SHVqHEGI7k2+OQ/oWMmWY2EQObbRQjRBdDPimh0h1WY=, server: 162.159.195.178, port: 2371, public-key: bmXOC+F1FxEMF9dyiK2H5/1SUtzH0JuVo51h2wPfgyo=, allowed-ips: ["0.0.0.0/0,::0/0"], udp: true, mtu: 1300, remote-dns-resolve: true, dns: [1.1.1.1, 1.0.0.1]}
    - { name: '☁️ CFWarp-I', type: wireguard, ip: 172.16.0.2,  ipv6: fd01:5ca1:ab1e:80fa:ab85:6eea:213f:f4a5, private-key: SHVqHEGI7k2+OQ/oWMmWY2EQObbRQjRBdDPimh0h1WY=, server: 162.159.195.11, port: 894, public-key: bmXOC+F1FxEMF9dyiK2H5/1SUtzH0JuVo51h2wPfgyo=, allowed-ips: ["0.0.0.0/0,::0/0"], udp: true, mtu: 1300, remote-dns-resolve: true, dns: [1.1.1.1, 1.0.0.1]}
    - { name: '☁️ CFWarp-J', type: wireguard, ip: 172.16.0.2,  ipv6: fd01:5ca1:ab1e:80fa:ab85:6eea:213f:f4a5, private-key: KIV5EsjDNA3mF11Sfedfvy9Xk8man/9MXYdJQxwffEo=, server: 162.159.195.65, port: 8319, public-key: bmXOC+F1FxEMF9dyiK2H5/1SUtzH0JuVo51h2wPfgyo=, allowed-ips: ["0.0.0.0/0,::0/0"], udp: true, mtu: 1300, remote-dns-resolve: true, dns: [1.1.1.1, 1.0.0.1]}
proxy-groups:
    - { name: Proxy, type: select, proxies: [自动选择, 故障转移, Auto_us, CFWarp, '香港 Cera Hysteria2', 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6', 'CFNB-UK-V6', 'CFTN-HK-V6', 'CF63-HK-V6', 'CFT2-US-V6'] }
    - { name: 自动选择, type: url-test, proxies: ['CFIR-US', 'CFFG-US', 'CF12-US', 'CFNI-US', 'CFCD-US', 'CFZ6-US', 'CFF3-US', 'CFSA-US', 'CFEC-US', 'CFNB-UK-V6', 'CFTN-HK-V6', 'CF63-HK-V6', 'CFT2-US-V6'], url: 'http://www.gstatic.com/generate_204', interval: 300 }
    - { name: 故障转移, type: fallback, proxies: ['CFIR-US', 'CFFG-US', 'CF12-US', 'CFNI-US', 'CFCD-US', 'CFZ6-US', 'CFF3-US', 'CFSA-US', 'CFEC-US', 'CFNB-UK-V6', 'CFTN-HK-V6', 'CF63-HK-V6', 'CFT2-US-V6'], url: 'http://www.gstatic.com/generate_204', interval: 300 }
    ...
    - { name: CFWarp, type: url-test, proxies: ['☁️ CFWarp-F', '☁️ CFWarp-G', '☁️ CFWarp-H', '☁️ CFWarp-I', '☁️ CFWarp-J'], url: 'http://www.gstatic.com/generate_204', interval: 300 }
    - { name: EmbyVIP, type: select, proxies: [Proxy, DIRECT, Auto_us, CFWarp, '香港 Cera Hysteria2', 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: EmbyDMM, type: select, proxies: [Proxy, Auto_us, CFWarp, '香港 Cera Hysteria2', 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: ChatGPT, type: select, proxies: ['TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: Telegram, type: select, proxies: [Proxy, Auto_us, CFWarp, '香港 Cera Hysteria2', 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: Apple, type: select, proxies: [DIRECT, Proxy, Auto_us, '香港 Cera Hysteria2', 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: Microsoft, type: select, proxies: [DIRECT, Proxy, Auto_us, '香港 Cera Hysteria2', 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    ...
    - { name: Netflix, type: select, proxies: [Proxy, '香港 Cera Hysteria2', 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: Spotify, type: select, proxies: [Proxy, Auto_us, '香港 Cera Hysteria2', 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: YouTube, type: select, proxies: [Proxy, Auto_us, CFWarp, '香港 Cera Hysteria2', 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: Disney, type: select, proxies: [Proxy, '香港 Cera Hysteria2', 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: 'Apple TV', type: select, proxies: [DIRECT, Proxy, Auto_us, CFWarp, '香港 Cera Hysteria2', 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: 'Asian TV', type: select, proxies: [DIRECT, Proxy, Auto_us, CFWarp, '香港 Cera Hysteria2', 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: 'Global TV', type: select, proxies: [Proxy, Auto_us, CFWarp, '香港 Cera Hysteria2', 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: Crypto, type: select, proxies: [Proxy, Auto_us, '香港 Cera Hysteria2', 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: Discord, type: select, proxies: [Proxy, Auto_us, '香港 Cera Hysteria2', 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: Speedtest, type: select, proxies: [DIRECT, Proxy, Auto_us, '香港 Cera Hysteria2', 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    ...
    - { name: 'Google FCM', type: select, proxies: [DIRECT, Proxy, Auto_us, '香港 Cera Hysteria2', 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: Scholar, type: select, proxies: [Proxy, Auto_us, '香港 Cera Hysteria2', 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: AdBlock, type: select, proxies: [REJECT, DIRECT] }
    - { name: Domestic, type: select, proxies: [DIRECT, Proxy, Auto_us, '香港 Cera Hysteria2', 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
rules:
    ...
    - 'DOMAIN-SUFFIX,jmsooo.com,CFWarp'
