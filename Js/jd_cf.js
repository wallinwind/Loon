...
proxies:
    ...
    - { name: 'CFEC-HK', type: vless, server: 8.210.151.69, port: 80, uuid: 66715dc1-eb36-42f0-8dc1-48db4087452e, udp: false, tls: false, network: ws, ws-opts: { path: '/?ed=2048', headers: { Host: worker-twilight-shadow-2a8c.ecwm1qv8.workers.dev } } }
...
proxy-groups:
    - { name: Proxy, type: select, proxies: [自动选择, 故障转移, Auto_us, 'CFT2-Test', 'CFIR-US', 'CFFG-US', 'CF12-US', 'CFNI-US', 'CFCD-US', 'CFZ6-US', 'CFF3-SG', 'CFSA-KR', 'CFEC-HK', 'CFNB-US', 'CFTN-US', 'CF63-HKv6', '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: 自动选择, type: url-test, proxies: ['CFT2-Test', 'CFIR-US', 'CFFG-US', 'CF12-US', 'CFNI-US', 'CFCD-US', 'CFZ6-US', 'CFF3-SG', 'CFSA-KR', 'CFEC-HK', 'CFNB-US', 'CFTN-US', 'CF63-HKv6'], url: 'http://www.gstatic.com/generate_204', interval: 300 }
    - { name: 故障转移, type: fallback, proxies: ['CFT2-Test', 'CFIR-US', 'CFFG-US', 'CF12-US', 'CFNI-US', 'CFCD-US', 'CFZ6-US', 'CFF3-SG', 'CFSA-KR', 'CFEC-HK', 'CFNB-US', 'CFTN-US', 'CF63-HKv6'], url: 'http://www.gstatic.com/generate_204', interval: 300 }
    - { name: Auto_us, type: url-test, proxies: ['CFIR-US', 'CFFG-US', 'CF12-US', 'CFNI-US', 'CFCD-US', 'CFZ6-US', 'CFNB-US'], url: 'http://www.gstatic.com/generate_204', interval: 300 }
