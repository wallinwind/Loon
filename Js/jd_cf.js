...
proxies:
    - {name: 🇺🇸 ccfdrivel_us, server: images.wayho.me, port: 443, type: vmess, uuid: 6ff7be1c-8924-49f5-b81c-02b8abceb143, alterId: 0, cipher: auto, tls: true, network: ws, ws-opts: {path: /peR2zvX9/, headers: {Host: images.wayho.me}}}
...
proxy-groups:
    - { name: Proxy, type: select, proxies: [自动选择, 故障转移, 🇺🇸 ccfdrivel_us, Auto_us, CFTR, '香港 Cera Hysteria2', 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6', 'CFNB-UK-V6', 'CFTN-HK-V6', 'CF63-HK-V6', 'CFT2-US-V6'] }
...
rules:
    - 'DOMAIN-SUFFIX,changhong.com,DIRECT'
    - 'DOMAIN,s.xxxx.icu,DIRECT'
