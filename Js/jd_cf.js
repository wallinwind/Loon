...
proxy-groups:
    ...
    - { name: CFTR, type: url-test, proxies: ['🇺🇸 YX01-US', '🇺🇸 YX02-US', '🇺🇸 CFFG-US', '🇺🇸 CFZ6-US'], url: 'http://www.gstatic.com/generate_204', interval: 300 }
    ...
    - { name: Netflix, type: select, proxies: [Proxy, CFTR, '香港 Cera Hysteria2', 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
