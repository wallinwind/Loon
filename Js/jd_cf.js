...
proxies:
    ...
    - { name: 'CFSA-SG', type: vless, server: 129.150.63.96, port: 80, uuid: 66715dc1-eb36-42f0-8dc1-48db4087452e, udp: false, tls: false, network: ws, ws-opts: { path: '/?ed=2048', headers: { Host: worker-restless-bird-23f0.gowest.workers.dev } } }
...
proxy-groups:
    - { name: Proxy, type: select, proxies: [自动选择, 故障转移, Auto_us, 'CFT2-Test', 'CFIR-US', 'CFFG-US', 'CF12-US', 'CFNI-US', 'CFCD-US', 'CFZ6-US', 'CFF3-NL', 'CFSA-SG', 'CFEC-US', 'CFNB-US', 'CFTN-US', 'CF63-SG', '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: 自动选择, type: url-test, proxies: ['CFT2-Test', 'CFIR-US', 'CFFG-US', 'CF12-US', 'CFNI-US', 'CFCD-US', 'CFZ6-US', 'CFF3-NL', 'CFSA-SG', 'CFEC-US', 'CFNB-US', 'CFTN-US', 'CF63-SG'], url: 'http://www.gstatic.com/generate_204', interval: 300 }
    - { name: 故障转移, type: fallback, proxies: ['CFT2-Test', 'CFIR-US', 'CFFG-US', 'CF12-US', 'CFNI-US', 'CFCD-US', 'CFZ6-US', 'CFF3-NL', 'CFSA-SG', 'CFEC-US', 'CFNB-US', 'CFTN-US', 'CF63-SG'], url: 'http://www.gstatic.com/generate_204', interval: 300 }
