...
proxy-groups:
    ...
    - { name: 自动选择, type: url-test, proxies: ['CFIR-US', 'CFFG-US', 'CF12-US', 'CFNI-US', 'CFCD-US', 'CFZ6-US', 'CFF3-US', 'CFSA-US', 'CFEC-US', 'CFNB-UK-V6', 'CFTN-HK-V6', 'CF63-HK-V6', 'CFT2-US-V6', '🇺🇸 YX01-US', '🇺🇸 YX02-US'], url: 'http://www.gstatic.com/generate_204', interval: 300 }
    - { name: 故障转移, type: fallback, proxies: ['CFIR-US', 'CFFG-US', 'CF12-US', 'CFNI-US', 'CFCD-US', 'CFZ6-US', 'CFF3-US', 'CFSA-US', 'CFEC-US', 'CFNB-UK-V6', 'CFTN-HK-V6', 'CF63-HK-V6', 'CFT2-US-V6', '🇺🇸 YX01-US', '🇺🇸 YX02-US'], url: 'http://www.gstatic.com/generate_204', interval: 300 }
    ...
    - { name: CFTR, type: url-test, proxies: ['🇺🇸 YX01-US', '🇺🇸 YX02-US'], url: 'http://www.gstatic.com/generate_204', interval: 300 }
