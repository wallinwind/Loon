...
proxies:
    ...
    - {name: '🇺🇸 CFEC-US', server: 104.19.91.170, port: 443, type: trojan, password: dsj32823923dsdhsj, sni: cf.irfortr.dns-dynamic.net, network: ws, ws-opts: {path: "/?ed=2560", headers: {Host: cf.irfortr.dns-dynamic.net}}, udp: true}
    ...
    - {name: '🇺🇸 US-0-0', server: 207.90.239.157, port: 15669, udp: true, skip-cert-verify: true, sni: www.bing.com, type: hysteria2, password: dongtaiwang.com}
    ...
    - {name: '🇰🇷 KR 07', server: 119.202.158.65, port: 10909, type: vless, uuid: 0050c022-8dae-42b6-9435-895654a42f97, tls: true, servername: TG.CMLiussss.cloudns.be, network: ws, ws-opts: {path: "/?proxyip=proxyip.kr.fxxk.dedyn.io", headers: {Host: TG.CMLiussss.cloudns.be}}, udp: true}
proxy-groups:
    - { name: Proxy, type: select, proxies: [CFTR, '🇺🇸 US-0-0', '🇺🇸 US-SAN JOSE-SJC 01', '🇰🇷 NRT 01', '🇰🇷 KR 07', '香港 Cera Hysteria2', 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6', '🇭🇰 CFTN-HK-V6', '🇭🇰 CF63-HK-V6'] }
    ...
    - { name: EmbyVIP, type: select, proxies: [Proxy, DIRECT, CFTR, '香港 Cera Hysteria2', 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: EmbyDMM, type: select, proxies: [Proxy, CFTR, '香港 Cera Hysteria2', 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: ChatGPT, type: select, proxies: [CFTR, 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: Telegram, type: select, proxies: [Proxy, CFTR, '香港 Cera Hysteria2', 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: Apple, type: select, proxies: [DIRECT, Proxy, CFTR, '香港 Cera Hysteria2', 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: Microsoft, type: select, proxies: [DIRECT, Proxy, CFTR, '香港 Cera Hysteria2', 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    ...
    - { name: Spotify, type: select, proxies: [Proxy, CFTR, '香港 Cera Hysteria2', 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: YouTube, type: select, proxies: [Proxy, CFTR, '香港 Cera Hysteria2', 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    ...
    - { name: 'Apple TV', type: select, proxies: [DIRECT, Proxy, CFTR, '香港 Cera Hysteria2', 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: 'Asian TV', type: select, proxies: [DIRECT, Proxy, CFTR, '香港 Cera Hysteria2', 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: 'Global TV', type: select, proxies: [Proxy, CFTR, '香港 Cera Hysteria2', 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: Crypto, type: select, proxies: [Proxy, CFTR, '香港 Cera Hysteria2', 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: Discord, type: select, proxies: [Proxy, CFTR, '香港 Cera Hysteria2', 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: Speedtest, type: select, proxies: [DIRECT, Proxy, CFTR, '香港 Cera Hysteria2', 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    ...
    - { name: 'Google FCM', type: select, proxies: [DIRECT, Proxy, CFTR, '香港 Cera Hysteria2', 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: Scholar, type: select, proxies: [Proxy, CFTR, '香港 Cera Hysteria2', 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
    - { name: AdBlock, type: select, proxies: [REJECT, DIRECT] }
    - { name: Domestic, type: select, proxies: [DIRECT, Proxy, CFTR, '香港 Cera Hysteria2', 'HKIPLC1', 'HKIPLC2', 'HGIEPL1', 'HGIEPL2', 'HKQAT1', 'HKQAT9', 'TWIPLC1', 'TWIPLC2', 'TWIEPL1', 'TWIEPL2', 'SGIEPL1', 'SGIEPL2', 'JPIEPL1', 'JPIEPL2', 'USIEPL1', 'USIEPL6'] }
rules:
    ...
    - 'DOMAIN-SUFFIX,51zmt.top,Global TV'
    - 'DOMAIN,litvpc-hichannel.cdn.hinet.net,Global TV'
