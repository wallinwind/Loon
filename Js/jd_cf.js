...
proxies:
    ...
    - { name: 'CFT2-JP-Oracle', type: vless, server: 146.56.180.83, port: 80, uuid: 66715dc1-eb36-42f0-8dc1-48db4087452e, udp: false, tls: false, network: ws, ws-opts: { path: '/?ed=2048', headers: { Host: worker-white-bush-a23f.t23pfjbk.workers.dev } } }
...
proxy-groups:
    - { name: Proxy, type: select, proxies: [自动选择, 故障转移, Auto_us, 'CFIR-US', 'CFFG-US', 'CF12-US', 'CFNI-US', 'CFCD-US', 'CFZ6-US', 'CFF3-US', 'CFSA-US', 'CFEC-US', 'CFNB-US-V5', 'CFTN-HK-V5', 'CF63-HK-V5', 'CFT2-JP-Oracle', '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: 自动选择, type: url-test, proxies: ['CFIR-US', 'CFFG-US', 'CF12-US', 'CFNI-US', 'CFCD-US', 'CFZ6-US', 'CFF3-US', 'CFSA-US', 'CFEC-US', 'CFNB-US-V5', 'CFTN-HK-V5', 'CF63-HK-V5', 'CFT2-JP-Oracle'], url: 'http://www.gstatic.com/generate_204', interval: 300 }
    - { name: 故障转移, type: fallback, proxies: ['CFIR-US', 'CFFG-US', 'CF12-US', 'CFNI-US', 'CFCD-US', 'CFZ6-US', 'CFF3-US', 'CFSA-US', 'CFEC-US', 'CFNB-US-V5', 'CFTN-HK-V5', 'CF63-HK-V5', 'CFT2-JP-Oracle'], url: 'http://www.gstatic.com/generate_204', interval: 300 }
