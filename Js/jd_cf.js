...
proxies:
    - { name: 'CFT2-Test', type: vless, server: 47.245.112.193, port: 80, uuid: 66715dc1-eb36-42f0-8dc1-48db4087452e, udp: false, tls: false, network: ws, ws-opts: { path: '/?ed=2048', headers: { Host: worker-white-bush-a23f.t23pfjbk.workers.dev } } }
    ...
    - { name: 'CFF3-JP', type: vless, server: 129.154.196.121, port: 80, uuid: 66715dc1-eb36-42f0-8dc1-48db4087452e, udp: false, tls: false, network: ws, ws-opts: { path: '/?ed=2048', headers: { Host: worker-summer-resonance-9629.iamnoname.workers.dev } } }
    - { name: 'CFSA-JP', type: vless, server: 64.110.83.150, port: 80, uuid: 66715dc1-eb36-42f0-8dc1-48db4087452e, udp: false, tls: false, network: ws, ws-opts: { path: '/?ed=2048', headers: { Host: worker-restless-bird-23f0.gowest.workers.dev } } }
    - { name: 'CFEC-JP', type: vless, server: 64.110.76.29, port: 80, uuid: 66715dc1-eb36-42f0-8dc1-48db4087452e, udp: false, tls: false, network: ws, ws-opts: { path: '/?ed=2048', headers: { Host: worker-twilight-shadow-2a8c.ecwm1qv8.workers.dev } } }
    - { name: 'CFNB-JP', type: vless, server: 129.154.223.213, port: 80, uuid: 66715dc1-eb36-42f0-8dc1-48db4087452e, udp: false, tls: false, network: ws, ws-opts: { path: '/?ed=2048', headers: { Host: worker-misty-smoke-d7f9.nb13l3ox.workers.dev } } }
    - { name: 'CFTN-JP', type: vless, server: 146.56.37.229, port: 80, uuid: 66715dc1-eb36-42f0-8dc1-48db4087452e, udp: false, tls: false, network: ws, ws-opts: { path: '/?ed=2048', headers: { Host: worker-purple-butterfly-8379.tn9fw5-q.workers.dev } } }
    - { name: 'CF63-JP', type: vless, server: 146.56.188.71, port: 80, uuid: 66715dc1-eb36-42f0-8dc1-48db4087452e, udp: false, tls: false, network: ws, ws-opts: { path: '/?ed=2048', headers: { Host: worker-cold-moon-5edb.63cdk1pq.workers.dev } } }
...
proxy-groups:
    - { name: Proxy, type: select, proxies: [自动选择, 故障转移, Auto_us, 'CFT2-Test', 'CFIR-US', 'CFFG-US', 'CF12-US', 'CFNI-US', 'CFCD-US', 'CFZ6-US', 'CFF3-JP', 'CFSA-JP', 'CFEC-JP', 'CFNB-JP', 'CFTN-JP', 'CF63-JP', '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: 自动选择, type: url-test, proxies: ['CFIR-US', 'CFFG-US', 'CF12-US', 'CFNI-US', 'CFCD-US', 'CFZ6-US', 'CFF3-JP', 'CFSA-JP', 'CFEC-JP', 'CFNB-JP', 'CFTN-JP', 'CF63-JP'], url: 'http://www.gstatic.com/generate_204', interval: 300 }
    - { name: 故障转移, type: fallback, proxies: ['CFIR-US', 'CFFG-US', 'CF12-US', 'CFNI-US', 'CFCD-US', 'CFZ6-US', 'CFF3-JP', 'CFSA-JP', 'CFEC-JP', 'CFNB-JP', 'CFTN-JP', 'CF63-JP'], url: 'http://www.gstatic.com/generate_204', interval: 300 }
