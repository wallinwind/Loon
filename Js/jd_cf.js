...
proxies:
    ...
    - { name: 'CFNB-HK', type: vless, server: 2606:4700:3038:1f1e:1e1a:9120:a2f1:bb8a, port: 80, uuid: 66715dc1-eb36-42f0-8dc1-48db4087452e, udp: false, tls: false, network: ws, ws-opts: { path: '/?ed=2048', headers: { Host: worker-misty-smoke-d7f9.nb13l3ox.workers.dev } } }
    - { name: 'CFTN-HK', type: vless, server: 2606:4700:90d7:564f:683c:6dc0:d676:db62, port: 80, uuid: 66715dc1-eb36-42f0-8dc1-48db4087452e, udp: false, tls: false, network: ws, ws-opts: { path: '/?ed=2048', headers: { Host: worker-purple-butterfly-8379.tn9fw5-q.workers.dev } } }
    - { name: 'CF63-HK', type: vless, server: 2606:4700:90d7:11df:7f57:31c6:cc2d:c2e7, port: 80, uuid: 66715dc1-eb36-42f0-8dc1-48db4087452e, udp: false, tls: false, network: ws, ws-opts: { path: '/?ed=2048', headers: { Host: worker-cold-moon-5edb.63cdk1pq.workers.dev } } }
    - { name: 'CFT2-HK', type: vless, server: 2606:4700:3038:e964:3e14:64b2:9a30:ce59, port: 80, uuid: 66715dc1-eb36-42f0-8dc1-48db4087452e, udp: false, tls: false, network: ws, ws-opts: { path: '/?ed=2048', headers: { Host: worker-white-bush-a23f.t23pfjbk.workers.dev } } }
...
proxy-groups:
    - { name: Proxy, type: select, proxies: [自动选择, 故障转移, Auto_us, 'CFIR-US', 'CFFG-US', 'CF12-US', 'CFNI-US', 'CFCD-US', 'CFZ6-US', 'CFF3-US', 'CFSA-US', 'CFEC-US', 'CFNB-HK', 'CFTN-HK', 'CF63-HK', 'CFT2-HK', '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: 自动选择, type: url-test, proxies: ['CFIR-US', 'CFFG-US', 'CF12-US', 'CFNI-US', 'CFCD-US', 'CFZ6-US', 'CFF3-US', 'CFSA-US', 'CFEC-US', 'CFNB-HK', 'CFTN-HK', 'CF63-HK', 'CFT2-HK'], url: 'http://www.gstatic.com/generate_204', interval: 300 }
    - { name: 故障转移, type: fallback, proxies: ['CFIR-US', 'CFFG-US', 'CF12-US', 'CFNI-US', 'CFCD-US', 'CFZ6-US', 'CFF3-US', 'CFSA-US', 'CFEC-US', 'CFNB-HK', 'CFTN-HK', 'CF63-HK', 'CFT2-HK'], url: 'http://www.gstatic.com/generate_204', interval: 300 }
