...
proxies:
    ...
    - { name: '☁️ CFWarp-F', type: wireguard, ip: 172.16.0.2, private-key: SHVqHEGI7k2+OQ/oWMmWY2EQObbRQjRBdDPimh0h1WY=, server: 162.159.195.92, port: 1070, public-key: bmXOC+F1FxEMF9dyiK2H5/1SUtzH0JuVo51h2wPfgyo=, allowed-ips: ["0.0.0.0/0,::0/0"], udp: true, mtu: 1300, remote-dns-resolve: true, dns: [1.1.1.1, 1.0.0.1]}
    - { name: '☁️ CFWarp-G', type: wireguard, ip: 172.16.0.2, private-key: SHVqHEGI7k2+OQ/oWMmWY2EQObbRQjRBdDPimh0h1WY=, server: 162.159.195.11, port: 7559, public-key: bmXOC+F1FxEMF9dyiK2H5/1SUtzH0JuVo51h2wPfgyo=, allowed-ips: ["0.0.0.0/0,::0/0"], udp: true, mtu: 1300, remote-dns-resolve: true, dns: [1.1.1.1, 1.0.0.1]}
    - { name: '☁️ CFWarp-H', type: wireguard, ip: 172.16.0.2, private-key: SHVqHEGI7k2+OQ/oWMmWY2EQObbRQjRBdDPimh0h1WY=, server: 162.159.195.178, port: 2371, public-key: bmXOC+F1FxEMF9dyiK2H5/1SUtzH0JuVo51h2wPfgyo=, allowed-ips: ["0.0.0.0/0,::0/0"], udp: true, mtu: 1300, remote-dns-resolve: true, dns: [1.1.1.1, 1.0.0.1]}
    - { name: '☁️ CFWarp-I', type: wireguard, ip: 172.16.0.2, private-key: SHVqHEGI7k2+OQ/oWMmWY2EQObbRQjRBdDPimh0h1WY=, server: 162.159.195.11, port: 894, public-key: bmXOC+F1FxEMF9dyiK2H5/1SUtzH0JuVo51h2wPfgyo=, allowed-ips: ["0.0.0.0/0,::0/0"], udp: true, mtu: 1300, remote-dns-resolve: true, dns: [1.1.1.1, 1.0.0.1]}
    - { name: '☁️ CFWarp-J', type: wireguard, ip: 172.16.0.2, private-key: KIV5EsjDNA3mF11Sfedfvy9Xk8man/9MXYdJQxwffEo=, server: 162.159.195.65, port: 8319, public-key: bmXOC+F1FxEMF9dyiK2H5/1SUtzH0JuVo51h2wPfgyo=, allowed-ips: ["0.0.0.0/0,::0/0"], udp: true, mtu: 1300, remote-dns-resolve: true, dns: [1.1.1.1, 1.0.0.1]}
proxy-groups:
