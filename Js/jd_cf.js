...
proxies:
    - { name: 'CFT2-Test', type: vless, server: 43.159.33.179, port: 80, uuid: 66715dc1-eb36-42f0-8dc1-48db4087452e, udp: false, tls: false, network: ws, ws-opts: { path: '/?ed=2048', headers: { Host: worker-white-bush-a23f.t23pfjbk.workers.dev } } }
    ...
    - { name: 'CFF3-SG', type: vless, server: 8.222.211.16, port: 80, uuid: 66715dc1-eb36-42f0-8dc1-48db4087452e, udp: false, tls: false, network: ws, ws-opts: { path: '/?ed=2048', headers: { Host: worker-summer-resonance-9629.iamnoname.workers.dev } } }
    ...
    - { name: 'CFEC-SG', type: vless, server: 8.222.214.231, port: 80, uuid: 66715dc1-eb36-42f0-8dc1-48db4087452e, udp: false, tls: false, network: ws, ws-opts: { path: '/?ed=2048', headers: { Host: worker-twilight-shadow-2a8c.ecwm1qv8.workers.dev } } }
...
proxy-groups:
    ...
    - { name: Telegram, type: select, proxies: [Proxy, Auto_us, Auto_sg, '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: Apple, type: select, proxies: [DIRECT, Proxy, Auto_us, Auto_sg, '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: Microsoft, type: select, proxies: [DIRECT, Proxy, Auto_us, Auto_sg, '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: Steam, type: select, proxies: [DIRECT, Proxy, Auto_us, Auto_sg, '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: Netflix, type: select, proxies: [Proxy, Auto_us, Auto_sg, '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: Spotify, type: select, proxies: [Proxy, Auto_us, Auto_sg, '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: YouTube, type: select, proxies: [Proxy, Auto_us, Auto_sg, '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: Disney, type: select, proxies: [Proxy, Auto_us, Auto_sg, '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: 'Apple TV', type: select, proxies: [DIRECT, Proxy, Auto_us, Auto_sg, '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: 'Asian TV', type: select, proxies: [DIRECT, Proxy, Auto_us, Auto_sg, '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: 'Global TV', type: select, proxies: [Proxy, Auto_us, Auto_sg, '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: Crypto, type: select, proxies: [Proxy, Auto_us, Auto_sg, '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: Discord, type: select, proxies: [Proxy, Auto_us, Auto_sg, '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: Speedtest, type: select, proxies: [DIRECT, Proxy, Auto_us, Auto_sg, '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: PayPal, type: select, proxies: [Proxy, DIRECT, Auto_us, Auto_sg, '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: 'Google FCM', type: select, proxies: [DIRECT, Proxy, Auto_us, Auto_sg, '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: Scholar, type: select, proxies: [Proxy, Auto_us, Auto_sg, '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: AdBlock, type: select, proxies: [REJECT, DIRECT] }
    - { name: Domestic, type: select, proxies: [DIRECT, Proxy, Auto_us, Auto_sg, '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
rules:
