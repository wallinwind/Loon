...
proxies:
    ...
    - { name: 'CFF3-JP', type: vless, server: 129.154.199.36, port: 80, uuid: 66715dc1-eb36-42f0-8dc1-48db4087452e, udp: false, tls: false, network: ws, ws-opts: { path: '/?ed=2048', headers: { Host: worker-summer-resonance-9629.iamnoname.workers.dev } } }
    - { name: 'CFSA-KR', type: vless, server: 129.154.198.60, port: 80, uuid: 66715dc1-eb36-42f0-8dc1-48db4087452e, udp: false, tls: false, network: ws, ws-opts: { path: '/?ed=2048', headers: { Host: worker-restless-bird-23f0.gowest.workers.dev } } }
    ...
    - { name: 'CFNB-JP', type: vless, server: 146.56.38.58, port: 80, uuid: 66715dc1-eb36-42f0-8dc1-48db4087452e, udp: false, tls: false, network: ws, ws-opts: { path: '/?ed=2048', headers: { Host: worker-misty-smoke-d7f9.nb13l3ox.workers.dev } } }
    - { name: 'CFTN-JP', type: vless, server: 129.154.192.252, port: 80, uuid: 66715dc1-eb36-42f0-8dc1-48db4087452e, udp: false, tls: false, network: ws, ws-opts: { path: '/?ed=2048', headers: { Host: worker-purple-butterfly-8379.tn9fw5-q.workers.dev } } }
    - { name: 'CF63-JP', type: vless, server: 129.154.192.52, port: 80, uuid: 66715dc1-eb36-42f0-8dc1-48db4087452e, udp: false, tls: false, network: ws, ws-opts: { path: '/?ed=2048', headers: { Host: worker-cold-moon-5edb.63cdk1pq.workers.dev } } }
...
proxy-groups:
    - { name: Proxy, type: select, proxies: [自动选择, 故障转移, Auto_us, 'CFT2-Test', 'CFIR-US', 'CFFG-US', 'CF12-US', 'CFNI-US', 'CFCD-US', 'CFZ6-US', 'CFF3-JP', 'CFSA-KR', 'CFEC-JP', 'CFNB-JP', 'CFTN-JP', 'CF63-JP', '香港 Cera Hysteria2', '香港 Cera Reality-gRPC', '香港 Cera Reality-Vision'] }
    - { name: 自动选择, type: url-test, proxies: ['CFIR-US', 'CFFG-US', 'CF12-US', 'CFNI-US', 'CFCD-US', 'CFZ6-US', 'CFF3-JP', 'CFSA-KR', 'CFEC-JP', 'CFNB-JP', 'CFTN-JP', 'CF63-JP'], url: 'http://www.gstatic.com/generate_204', interval: 300 }
    - { name: 故障转移, type: fallback, proxies: ['CFIR-US', 'CFFG-US', 'CF12-US', 'CFNI-US', 'CFCD-US', 'CFZ6-US', 'CFF3-JP', 'CFSA-KR', 'CFEC-JP', 'CFNB-JP', 'CFTN-JP', 'CF63-JP'], url: 'http://www.gstatic.com/generate_204', interval: 300 }
